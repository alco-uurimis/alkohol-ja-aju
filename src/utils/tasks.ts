...
export function memoryRound(pool:readonly string[]=words){const shuffled=shuffle(pool);return {targets:shuffled.slice(0,8),options:shuffle(shuffled.slice(0,16))};}
