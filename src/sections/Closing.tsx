...
export default function Closing({lang}:{lang:'et'|'ru'}){
  ...
  return <>
    ...
    <Section id="tagasiside" number={ru?'06 / ОБРАТНАЯ СВЯЗЬ':'06 / TAGASISIDE'} title={ru?'Анонимный опрос о сайте':'Anonüümne küsitlus veebilehe kohta'} intro={ru?'Теперь материал завершён. Оцени понятность, интерес, сложность заданий и удобство сайта. Не указывай имя, контакты, сведения о здоровье или другую личную информацию.':'Õppematerjal on nüüd läbitud. Hinda arusaadavust, huvi, ülesannete raskust ja veebilehe kasutusmugavust. Ära lisa nime, kontaktandmeid, terviseandmeid ega muud isiklikku teavet.'}>
