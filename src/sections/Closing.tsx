...
export default function Closing({lang,summary}:{lang:'et'|'ru';summary?:ReactNode}){
  ...
  return <>
    <Section id="meelespea" number={ru?'06 / ГЛАВНОЕ':'06 / VÕTA KAASA'} title={ru?'Что стоит запомнить?':'Mida tasub meeles pidada?'} intro={ru?'Короткое резюме после упражнений, игр и проверки знаний.':'Lühikokkuvõte pärast harjutusi, mänge ja teadmiste kontrolli.'}>
    ...
    <Section id="tagasiside" number={ru?'07 / ОБРАТНАЯ СВЯЗЬ':'07 / TAGASISIDE'} title={ru?'Анонимный опрос о сайте':'Anonüümne küsitlus veebilehe kohta'} intro={ru?'Теперь основной материал завершён. Оцени понятность, интерес, сложность заданий и удобство сайта. Не указывай имя, контакты, сведения о здоровье или другую личную информацию.':'Põhimaterjal on nüüd läbitud. Hinda arusaadavust, huvi, ülesannete raskust ja veebilehe kasutusmugavust. Ära lisa nime, kontaktandmeid, terviseandmeid ega muud isiklikku teavet.'}>
