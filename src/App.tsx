...
export default function App(){
  ...
  return <>
    ...
    <header className="header">
      ...
      <div className="header-progress" aria-label={ru?`Прогресс по сайту: ${visited.size} из ${trackedIds.length}`:`Lehe läbimise progress: ${visited.size} / ${trackedIds.length}`}>
        <span className="header-progress-label">{ru?'Прогресс':'Progress'} · {visited.size}/{trackedIds.length}</span>
        <div className="header-progress-track" aria-hidden="true"><div className="header-progress-fill" style={{width:`${progress}%`}}/></div>
      </div>
    </header>
